...
that represents how lawful or chaotic they are, and a value in the y direction that represents how good or evil they are. In this example, I've used my cats, which you can find in the dataset-returning function `align_cats()` that is part of this package.
...
path <- system.file(package = "ggalignment")
align_cats_rect <-
  align_cats %>%
  dplyr::mutate(img = c(align_cats$img[1:3],
                        paste0(path, "/img/gray_2.png")))
