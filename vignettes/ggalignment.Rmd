...
that represents how lawful or chaotic they are, and a value in the y direction that represents how good or evil they are. In this example, I've used my cats, which you can find as a dataset called `align_cats`.
